                            ...
                            std::string outputdir, bool fixmean, bool saveplot, std::string name, std::string option)
{
  ...
  RooAddPdf* sig_mc_a = new RooAddPdf("sig_mc_a", "", RooArgList(RooGaussian("sig_mc_a1", "", *mass, *(mcpars[6]), *(mcpars[7])), RooGaussian("sig_mc_a2", "", *mass, *(mcpars[6]), *(mcpars[8]))), RooArgList(*(mcpars[9])), true);
  RooAddPdf* pdf_mc_a = new RooAddPdf("pdf_mc_a", "", RooArgList(*sig_mc_a), RooArgList(*(mcpars[5])));
  RooFitResult* fitmc_mc_a = pdf_mc_a->fitTo(*dshmc_a, Save());
  ...
  RooAddPdf* sig_mc_b = new RooAddPdf("sig_mc_b", "", RooArgList(RooGaussian("sig_mc_b1", "", *mass, *(mcpars[11]), *(mcpars[12])), RooGaussian("sig_mc_b2", "", *mass, *(mcpars[11]), *(mcpars[13]))), *(mcpars[14]));
  RooAddPdf* pdf_mc_b = new RooAddPdf("pdf_mc_b", "", RooArgList(*sig_mc_b), RooArgList(*(mcpars[10])));
  RooFitResult* fitmc_mc_b = pdf_mc_b->fitTo(*dshmc_b, Save());
  ...
  RooAddPdf* sig_a = new RooAddPdf("sig_a", "", RooArgList(RooGaussian("sig_a1", "", *mass, *(pars[6]), *(pars[7])), RooGaussian("sig_a2", "", *mass, *(pars[6]), *(pars[8]))), RooArgList(*(pars[9])), true);
  ...
  RooAddPdf* sig_b = new RooAddPdf("sig_b", "", RooArgList(RooGaussian("sig_b1", "", *mass, *(pars[11]), *(pars[12])), RooGaussian("sig_b2", "", *mass, *(pars[11]), *(pars[13]))), *(pars[14]), true);
  pars[0] = new RooRealVar("par0", "", 0, ); // parlimits !!! todo
  pars[1] = new RooRealVar("par1", "", 0, );
  pars[2] = new RooRealVar("par2", "", 0, );
  pars[3] = new RooRealVar("par3", "", 0, );
  pars[4] = new RooRealVar("par4", "", 0, );
  RooPolynomial bkg("bkg", "", *mass, RooArgSet(*(pars[0]), *(pars[1]), *(pars[2]), *(pars[3]), *(pars[4])));
  RooRealVar* nbkg = new RooRealVar("nbkg", "", 1, 1, 1); nbkg.setConstant(); // dull
  RooAddPdf* pdf = new RooAddPdf("pdf_a", "", RooArgList(*sig_a, *sig_b, *bkg), RooArgList(*(pars[5]), *(pars[10]), *nbkg));
  if(!fixmean)
    {
  ...
  RooFitResult* fitr = pdf->fitTo(*dsh, Save());
  ...
  xjjroot::settfstyle(fsig_a, color_a, 2, 3, color_a, 0.3, 1001);
  fsig_a->Draw("same");
  ...
  xjjroot::settfstyle(fsig_b, color_b, 2, 3, color_b, 0.3, 1001);
  fsig_b->Draw("same");
...
// RooGaussian sig_a1("sig_a1", "", *mass, par6, par7);
// RooGaussian sig_a2("sig_a2", "", *mass, par6, par8);
// RooAddPdf* sig_a = new RooAddPdf("sig_a", "", RooArgList(sig_a1, sig_a2), RooArgList(par9), true);
