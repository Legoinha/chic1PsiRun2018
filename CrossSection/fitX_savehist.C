                   ...
                   std::string cut, std::string cutgen, std::string cutgenacc, std::string cutpre, std::string output)
{
  ...
  xjjroot::printhist(ntmix_skimhBenr);
