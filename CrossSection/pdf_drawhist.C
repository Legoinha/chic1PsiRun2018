...
void pdf_drawhist(std::string output)
{
  ...
  xjjroot::setthgrstyle(hhyieldpromptCorr_a, fitX::color_a, 20, 1.2, fitX::color_a, 2, 1);
  ...
  xjjroot::setthgrstyle(hhyieldpromptCorr_b, fitX::color_b, 20, 1.2, fitX::color_b, 2, 1);
  ...
  xjjroot::setthgrstyle(hhratio, kBlack, 21, 1.2, kBlack, 1, 1);
  for(int i=0; i<fitopt.size(); i++)
    {
      ...
      xjjroot::setthgrstyle(hyieldpromptCorr[tt], xjjroot::mycolor_middle[xjjroot::cc[i]], 20, 1.2, xjjroot::mycolor_middle[xjjroot::cc[i]], 2, 1);
      xjjroot::sethempty(hratio[tt]);
      xjjroot::setthgrstyle(hratio[tt], xjjroot::mycolor_middle[xjjroot::cc[i]], 21, 1.2, xjjroot::mycolor_middle[xjjroot::cc[i]], 1, 1);
